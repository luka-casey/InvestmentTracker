                ...
                {stocks.map((stock, index) => {
                    ...
                    return (
                        <tr className="stock-table-row" key={index}>
                            ...
                            <td
                                className={`stock-table-cell ${todaysChangeValue >= 0 ? 'positive' : 'negative'
                                    }`}
                            >
                                {stock.todaysChange}
                            </td>
                            ...
                            <td
                                className={`stock-table-cell ${stock.todaysChangeNumeral >= 0 ? 'positive' : 'negative'
                                    }`}
                            >
                            ...
                            <td
                                className={`stock-table-cell ${totalChangeValue >= 0 ? 'positive' : 'negative'
                                    }`}
                            >
                                {totalChangeValue.toFixed(2)}
                            </td>
                            <td
                                className={`stock-table-cell ${stock.totalChangePercent >= 0 ? 'positive' : 'negative'
                                    }`}
                            >
